...
public class PsychologicalDistanceBetweenThreeClosestPeople {

    private static int size, answer;
    private static final Map<String, Integer> mbtiNumberMapper = new HashMap<>();
    ...
    private static void generateMBTIMapper() {
        String[] mbti = new String[]{"ISTJ", "ISFJ", "INFJ", "INTJ",
                                     "ISTP", "ISFP", "INFP", "INTP",
                                     "ESTP", "ESFP", "ENFP", "ENTP",
                                     "ESTJ", "ESFJ", "ENFJ", "ENTJ"};
        for (int i = 0; i < 16; ++i)
