package baekjoon.implementation;// https://www.acmicpc.net/problem/15644

import java.io.*;
import java.util.*;

public class BeadEscape3 {

    // up, right, down, left
    private static final char[] command = {'U', 'R', 'D', 'L'};
    ...
    private void dfs(Balls balls, int depth, String path) {
        ...
        for (int dir = 0; dir < 4; ++dir) {
            ...
            dfs(res, depth + 1, path + command[dir]);
        }
    }
